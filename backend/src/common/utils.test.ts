...
import {decode91, extractAmateurCode, extractCode, extractFC2, parseRelativeDay} from "./utils";
...
describe('utils tests', () => {
    ...
    it('extract fc2', () => {
        const inputs: string[] = [
            ...
            'fc2ppv-2589532【千華缭乱&未步奈奈】传说的开始 SSS级超级偶像惊艳降临',
            'BF-744 [自提征用]辣妹家庭教师 小野坂唯香',
            '这条里没有编号',
    ...
    it('test parse date', () => {
        console.log(parseRelativeDay('1天5小时前'));   // 2025-10-14
        console.log(parseRelativeDay('1小时20分钟前')); // 2025-10-14
        console.log(parseRelativeDay('2周3天前'));     // 2025-09-23
        console.log(parseRelativeDay('30分钟前'));     // 2025-10-14
        console.log(parseRelativeDay('48小时前'));     // 2025-10-12
    })
})